...
class DbField {
    ...
    public function isAutoIncrement() {
        if (stripos($this->extra, "auto_increment") !== FALSE) {
            return true;
        }
        return false;
    }
    ...
    /**
     * Checks if a field must be generated by the DB/repository layer
     * @return bool true is the field is a generated one, false otherwise
     */
    public function isGenerated() {
        ...
        if (stripos($this->default, "CURRENT_TIMESTAMP") !== FALSE) {
            return true;
        }
